...
public class FacetValueNumberRange<NATIVE> extends FacetHistogram<NATIVE> {
	...
	public FacetValueNumberRange(Node facet, NATIVE rangeleftvalue,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FacetValueNumberRange other = (FacetValueNumberRange) obj;
		if (facet == null) {
			if (other.facet != null)
				return false;
