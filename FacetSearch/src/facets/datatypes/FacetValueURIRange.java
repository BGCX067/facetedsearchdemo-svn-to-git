...
public class FacetValueURIRange extends FacetHistogram<String> {
	...
	public FacetValueURIRange(Node facet, String rangeleftvalue,
			String rangerightvalue, Node left, Node right, Integer binNumber,
			HistogramBuilder<String> facethistogram, ClassType ct) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FacetValueURIRange other = (FacetValueURIRange) obj;
		if (facet == null) {
			if (other.facet != null)
				return false;
...
//}
	...
	public Map<?, Integer> getFacetValueRangeData() {
		...
		URIHistogramBuilder builder = (URIHistogramBuilder) facethistogrambuilder;
